...
<head>
  ...
  ================================================== -->
    ...
    <!-- CSS
  ================================================== -->
  	<link rel="stylesheet" href="{{asset('Frontend-assets/css/zerogrid.css')}}">
	...
	<!--[if lt IE 8]>
       <div style=' clear: both; text-align:center; position: relative;'>
         <a href="http://windows.microsoft.com/en-US/internet-explorer/products/ie/home?ocid=ie6_countdown_bannercode">
           <img src="http://storage.ie6countdown.com/assets/100/Frontend-assets/Frontend-assets/images/banners/warning_bar_0000_us.jpg" border="0" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today." />
        </a>
      </div>
    <![endif]-->
    <!--[if lt IE 9]>
		<script src=Frontend-assets/js/html5.js"></script>
		<script src=Frontend-assets/js/css3-mediaqueries.js"></script>
	<![endif]-->
...
<div class="wrap-body">
	...
	<header>
		<div class="zerogrid">
			<center><div class="logo"><img src="Frontend-assets/images/logo.png"></div></center>
		</div>
	</header>
		...
		<div class="row">
			<div class="col-1-3">
				<div class="wrap-col">
					...
					<div class="row">
						<img src="Frontend-assets/Frontend-assets/images/a-1.jpg">
						<h5>Nick Roach</h5>
